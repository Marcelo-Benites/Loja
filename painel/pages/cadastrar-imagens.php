...
<div class="box-content">
	<h2><i class="fa fa-pencil"></i>Cadastrar Imagem Moto</h2>
...
if($sucesso){
				...
				$sql = MySql::conectar()->prepare("INSERT INTO `tb_text.moto` VALUES (null,?,?)");
				$sql->execute(array($nome,$descricao));
				$lastId = MySql::conectar()->lastInsertId();
				foreach ($imagens as $key => $value) {
					MySql::conectar()->exec("INSERT INTO `tb_site.moto` VALUES (null,$lastId,'$value')");
				}
