...
<div class="box-content">
	<h2><i class="fa fa-pencil"></i>Cadastrar Outros Veículos</h2>
...
if($sucesso){
				...
				$sql = MySql::conectar()->prepare("INSERT INTO `tb_text.outros` VALUES (null,?,?)");
				$sql->execute(array($nome,$descricao));
				$lastId = MySql::conectar()->lastInsertId();
				foreach ($imagens as $key => $value) {
					MySql::conectar()->exec("INSERT INTO `tb_site.outros` VALUES (null,$lastId,'$value')");
				}
